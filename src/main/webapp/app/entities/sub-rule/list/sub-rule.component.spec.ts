...
import { SubRuleComponent } from './sub-rule.component';

describe('Component Tests', () => {
  describe('SubRule Management Component', () => {
    let comp: SubRuleComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [SubRuleComponent],
      })
        .overrideTemplate(SubRuleComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.subRules[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
