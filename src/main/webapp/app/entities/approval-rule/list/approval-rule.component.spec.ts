...
describe('Component Tests', () => {
  describe('ApprovalRule Management Component', () => {
    let comp: ApprovalRuleComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ApprovalRuleComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.approvalRules[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
